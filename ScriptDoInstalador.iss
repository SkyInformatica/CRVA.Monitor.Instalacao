...
Source: "{#CaminhoDaFonteDaAplicacao}\x64\Armazenamento\Registros.db"; DestDir: "{app}"; Flags: uninsneveruninstall noencryption nocompression; Check: Is64BitInstallMode;
...
Source: "{#CaminhoDaFonteDaAplicacao}\x86\Armazenamento\Registros.db"; DestDir: "{app}"; Flags: noencryption uninsneveruninstall nocompression; Check: InstalacaoEm32Bits;
