...
Source: "{#CaminhoDaFonteDaAplicacao}\x64\Armazenamento"; DestDir: "{app}"; Flags: recursesubdirs createallsubdirs uninsneveruninstall noencryption nocompression; Check: Is64BitInstallMode;
...
Source: "{#CaminhoDaFonteDaAplicacao}\x86\Armazenamento"; DestDir: "{app}"; Flags: recursesubdirs createallsubdirs noencryption uninsneveruninstall nocompression; Check: InstalacaoEm32Bits;
